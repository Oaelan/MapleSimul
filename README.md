...
### 사용방법
 - 스타포스 시뮬레이션
	1.	왼쪽 창에 있는 시뮬레이션 버튼에서 착용 레벨과 스타포스 단계 선택창을 본인의 상황에 맞게 체크한다.
	2.	사용자가 등급 하락을 원하지 않을 경우, ‘스타포스 고정’을 선택한다.
스타캐치(강화 확률을 올리기 위한 미니게임)를 원할 경우, 스타캐치 버튼을 클릭한다.
그 외에도 사용자의 상황에 맞게 버튼을 클릭하거나 해제한다.
	3.	강화 버튼을 눌러 강화 결과를 확인한다.
	4.	20성 이상 강화에 성공하면, 강화 이펙트를 구경할 수 있다.
<img width="783" alt="스크린샷 2025-04-23 오후 3 27 25" src="https://github.com/user-attachments/assets/bb1e1e98-0411-480a-b213-db3f3062363a" />
